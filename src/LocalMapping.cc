      ...
      infoInertial(Eigen::MatrixXd::Zero(9, 9))
{
    ...
    f_lm << "# Timestamp KF, Num CovKFs, Num KFs, Num RecentMPs, Num MPs, processKF, MPCulling, CreateMP, SearchNeigh,
                ...
                if (mpAtlas->KeyFramesInMap() > 2)
                {
                    ...
                    else
                    {
                        ...
                        Optimizer::LocalBundleAdjustment(
                            mpCurrentKeyFrame, &mbAbortBA, mpCurrentKeyFrame->GetMap(), num_FixedKF_BA);
